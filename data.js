const HOAH_DATA = {
    translations: {
        en: {
            ...
            "help.step3.title": "3. Cloud Streaming Dictation",
            "help.step3.desc": "HoAh also supports <strong>cloud real-time streaming</strong> dictation for <strong>lower latency</strong> — text appears as you speak. We recommend <strong>ElevenLabs</strong> for the best overall experience. An API key from the provider is required.",
            "help.provider.elevenlabs.desc": "Scribe v2 model. <strong>Best overall streaming experience</strong>. Excellent multilingual support.",
            "help.provider.openai_streaming.desc": "GPT-4o Transcribe. <strong>Fastest streaming</strong>. Smart voice activity detection built in.",
            "help.provider.amazon.desc": "AWS streaming transcription. <strong>Enterprise-grade</strong>. Reliable and multilingual.",
            "help.step4.title": "4. Alternative: Run AI Locally with Ollama",
            "help.step4.desc": "Don't want to use cloud APIs? <strong>Ollama</strong> lets you run AI models entirely on your Mac — no API key, no internet, no cost. Perfect for privacy-focused users.",
            ...
            "guide.advanced.desc": "Want to fix grammar or translate? <br>1. Get a free <a href='../help/' class='inline-link'>API Key</a> (e.g. Groq), or use <strong>Ollama</strong> for fully local AI (no key needed).<br>2. In sidebar, click <strong>AI Action</strong> → <strong>Add Configuration</strong>.<br>3. Paste your key (or select Ollama) and <strong>Save</strong>.<br>4. Turn on <strong>Enable AI Action</strong>.<br>5. Select a <strong>Default Action</strong> (e.g. Polish).<br><br>Want lower-latency dictation? Check out <a href='../help/' class='inline-link'>Cloud Streaming</a> options like ElevenLabs.",
        ...
        zh: {
            ...
            "help.back": "← 返回首页",
            "help.step3.title": "3. 云端实时流式听写",
            "help.step3.desc": "HoAh 还支持<strong>云端实时流式</strong>听写，<strong>延迟更低</strong> — 边说边出字。推荐使用 <strong>ElevenLabs</strong>，综合体验最佳。需要对应服务商的 API Key。",
            "help.provider.elevenlabs.desc": "Scribe v2 模型。<strong>综合体验最佳的流式转写</strong>。优秀的多语言支持。",
            "help.provider.openai_streaming.desc": "GPT-4o Transcribe。<strong>最快的流式转写</strong>。内置智能语音活动检测。",
            "help.provider.amazon.desc": "AWS 流式转写。<strong>企业级</strong>。稳定可靠，支持多语言。",
            "help.step4.title": "4. 替代方案：使用 Ollama 本地运行 AI",
            "help.step4.desc": "不想使用云端 API？<strong>Ollama</strong> 让你在 Mac 上完全本地运行 AI 模型 — 无需密钥、无需联网、完全免费。非常适合注重隐私的用户。",
            ...
            "guide.advanced.desc": "想要自动修复语法或翻译？<br>1. 获取免费 <a href='../help/' class='inline-link'>API Key</a>（如 Groq），或使用 <strong>Ollama</strong> 完全本地运行 AI（无需密钥）。<br>2. 点击侧边栏 <strong>AI Action</strong> → <strong>添加配置</strong>。<br>3. 粘贴 Key（或选择 Ollama）并<strong>保存</strong>。<br>4. 开启 <strong>Enable AI Action</strong>。<br>5. 选择一个 <strong>Default Action</strong>（如 Polish）。<br><br>想要更低延迟的听写？查看 <a href='../help/' class='inline-link'>云端流式听写</a>选项（如 ElevenLabs）。",
